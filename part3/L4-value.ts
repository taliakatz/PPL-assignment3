...
// added : Promise
export type SExpValue = number | boolean | string | PrimOp | Closure | SymbolSExp | EmptySExp | CompoundSExp | Promise;
...
export const valueToString = (val: Value): string =>
    ...
    // isPromise(val) ? promiseToString(val) :
    "Error: unknown value type "+val 

export const promiseToString = (p : Promise) : string =>
    `<Promise: ${p.exp}>`
